...
def test_str_detect_single():
    ...
    actual = tf.mutate(x = tp.str_detect('name', 'a'),
...
def test_str_detect_multiple():
    ...
    tf = tp.TibbleFrame(name = ['apple', 'banana', 'pear', 'grape'])
    actual = tf.mutate(x = tp.str_detect('name', ['a', 'e']),
...
def test_str_remove_all():
    ...
    expected = tp.TibbleFrame(name = ['apple', 'banana', 'pear', 'grape'], new_name = ['pple', 'bnn', 'per', 'grpe'])
...
def test_str_remove():
    ...
    expected = tp.TibbleFrame(name = ['apple', 'banana', 'pear', 'grape'], new_name = ['pple', 'bnana', 'per', 'grpe'])
...
def test_str_replace_all():
    ...
    expected = tp.TibbleFrame(name = ['apple', 'banana', 'pear', 'grape'], new_name = ['Apple', 'bAnAnA', 'peAr', 'grApe'])
