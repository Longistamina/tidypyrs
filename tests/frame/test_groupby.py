...
def test_group_by_summarise_alias():
    ...
    actual = tf.group_by("group").summarise(total=c("value").sum()).arrange("group")
...
def test_group_by_agg():
    ...
    actual = tf.group_by("group").agg(total=c("value").sum()).arrange("group")
...
def test_group_by_maintain_order():
    ...
    actual = tf.group_by("group", maintain_order=True).summarize(total=c("value").sum())
