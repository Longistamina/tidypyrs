...
def test_group_by_summarise_alias():
    ...
    actual = tl.group_by("group").summarise(total=c("value").sum()).arrange("group")
...
def test_group_by_agg():
    ...
    actual = tl.group_by("group").agg(total=c("value").sum()).arrange("group")
...
def test_group_by_maintain_order():
    ...
    actual = tl.group_by("group", maintain_order=True).summarize(total=c("value").sum())
