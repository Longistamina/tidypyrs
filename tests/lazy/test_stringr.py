...
def test_str_detect_single():
    ...
    actual = tl.mutate(x = tp.str_detect('name', 'a'),
...
def test_str_detect_multiple():
    ...
    tl = tp.TibbleLazy(name = ['apple', 'banana', 'pear', 'grape'])
    actual = tl.mutate(x = tp.str_detect('name', ['a', 'e']),
...
def test_str_remove_all():
    ...
    expected = tp.TibbleLazy(name = ['apple', 'banana', 'pear', 'grape'], new_name = ['pple', 'bnn', 'per', 'grpe'])
...
def test_str_remove():
    ...
    expected = tp.TibbleLazy(name = ['apple', 'banana', 'pear', 'grape'], new_name = ['pple', 'bnana', 'per', 'grpe'])
...
def test_str_replace_all():
    ...
    expected = tp.TibbleLazy(name = ['apple', 'banana', 'pear', 'grape'], new_name = ['Apple', 'bAnAnA', 'peAr', 'grApe'])
